...
public class GsonSQJsonMessageConverterTest {

	private SQJsonMessageConverter messageConverter = new SQJsonMessageConverter(new GsonJsonSerializationProvider());
